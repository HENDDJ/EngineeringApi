...
public class GenerateTemplateCodeUtil {
    ...
    /** 表名*/
    static String TABLE_NAME = "hik_region";

    /** 创建liquibase xml 的id*/
    static final String CHANGE_SET_ID = "20190709-01";

    /** 类名*/
    static final String CLASS_NAME = "HikRegion";

    /** 类注释*/
    static final String CLASS_EXPLAIN = "海康区域";
